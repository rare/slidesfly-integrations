...
| Secure delivery | GitHub and npm use HTTPS; releases publish SHA-256/SHA-512 checksum files and the verifier recomputes registry artifact hashes. | Current release artifacts do not claim signatures or SLSA provenance. |
